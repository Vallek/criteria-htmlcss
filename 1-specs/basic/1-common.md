...
Для раскладки на страницах используются только флексы и гриды. Верстальщик решает, что где уместнее использовать. Например:

- Для сложной многомерной раскладки — гриды.
- Для раскладки элементов в ряд — флексы.
